...
import PlanetsAndMoonsHome from "./pages/PlanetsAndMoons/PlanetsAndMoonsHome";
    ...
    <Router>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route
            path="/gezegenler-ve-uydular/mars/mars-atmosferi-ve-iklimi"
            element={<MarsAtmosphereAndClimate />}
          />
          <Route
            path="/gezegenler-ve-uydular/mars/mars-yuzeyi-ve-topografyasi"
            element={<MarsSurfaceAndTopography />}
          />
          <Route
            path="/gezegenler-ve-uydular/mars/mars-su-kaynaklari"
            element={<MarsWaterResources />}
          />
          <Route
            path="/gezegenler-ve-uydular/mars/mars-yasanabilirligi"
            element={<MarsHabitability />}
          />
          <Route
            path="/gezegenler-ve-uydular/mars/mars-gorevleri"
            element={<MarsMissions />}
          />
          <Route
            path="/gezegenler-ve-uydular/mars/mars-jeolojik-zaman-cizelgesi"
            element={<MarsGeologicalTimeline />}
          />
          <Route
            path="/gezegenler-ve-uydular/mars/mars-uydulari"
            element={<MarsMoons />}
          />

          <Route path="gezegenler-ve-uydular/dunya" element={<EarthHome />} />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-atmosferi-ve-iklimi"
            element={<EarthAtmosphereAndClimate />}
          />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-yuzeyi-ve-topografyasi"
            element={<EarthSurfaceAndTopography />}
          />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-su-kaynaklari"
            element={<EarthWaterResources />}
          />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-yasanabilirligi"
            element={<EarthHabitability />}
          />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-gorevleri"
            element={<EarthMissions />}
          />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-jeolojik-zaman-cizelgesi"
            element={<EarthGeologicalTimeline />}
          />
          <Route
            path="/gezegenler-ve-uydular/dunya/dunya-uydulari"
            element={<EarthMoons />}
          />
        </Route>
      </Routes>
