  ...
  return (
    <div>
      ...
      <div className="p-4 max-w-4xl mx-auto">
        <div className="mb-4">
          <label htmlFor="solSelect" className="block text-lg font-medium text-gray-700 mb-2">Sol Seçin:</label>
          <select
            id="solSelect"
        ...
        <div className="mb-4">
          <label className="block text-lg font-medium text-gray-700 mb-2">Grafik Türü Seçin:</label>
          <div className="flex space-x-4">
            <button
              className={`py-2 px-4 rounded-lg ${chartType === 'line' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
              onClick={() => handleChartTypeChange('line')}
            >
              Çizgi Grafiği
            </button>
            <button
              className={`py-2 px-4 rounded-lg ${chartType === 'doughnut' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
